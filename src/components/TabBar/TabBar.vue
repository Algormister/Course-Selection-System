  ...
  <div id="tab-bar">
    <el-row>
        <el-col :span="24">
            ...
            <div style="font-size:14px;height: 37px; background-color:#1A2226; padding: 10px 25px 10px 15px; color:#ccc; line-height:37px;">
            ...
            active-text-color="#ffd04b">
                <el-submenu index="1">
                    <template #title>
                        <span style="font-size: 16px;color:white;">学生选课</span>
                    </template>
                    <el-menu-item-group>
